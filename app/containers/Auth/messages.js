...
export const scope = 'boilerplate.containers.Auth';

export default defineMessages({
  header: {
    id: `${scope}.header`,
    defaultMessage: 'Authintication',
  },
  scaffoldingHeader: {
  ...
  enterUsername: {
    id: `${scope}.enter.username`,
    defaultMessage: 'Enter your username',
  },
  enterPassword: {
    id: `${scope}.enter.password`,
  ...
  trymeHashPrefix: {
    id: `${scope}.tryme.hashPrefix`,
    defaultMessage: '#',
  },
  yourWelcome: {
    id: `${scope}.your.welcome`,
    defaultMessage: 'You are welcome',
  },
});
